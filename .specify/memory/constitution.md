<!--
Sync Impact Report
- Version change: 1.1.0 → 1.2.0 (MINOR: новый NON-NEGOTIABLE принцип IX —
  TDD + coverage gate; расширение Quality Gates)
- Modified principles: none renamed; I–VIII unchanged in intent
- Added sections: IX. Test-Driven Development & Coverage (NON-NEGOTIABLE)
- Removed sections: none
- Templates / guidance:
  - .specify/templates/plan-template.md ✅ (Constitution Check gates)
  - .specify/templates/tasks-template.md ✅ (tests MANDATORY / TDD)
  - .specify/templates/spec-template.md ✅ (NFR note on TDD — no structural change needed beyond existing Independent Test)
  - .cursor/skills/speckit-tasks/SKILL.md ✅ (Tests REQUIRED per constitution)
  - docs/spec-kit.md ✅ (упоминание IX)
  - docs/makefile.md ✅ (coverage в make test)
  - specs/001-cli-skeleton/plan.md ✅ (gate G9)
- Follow-up TODOs:
  - Усилить Makefile: `make test` с coverage profile + fail-on-regression
    (сейчас `go test ./...` без порога; принцип IX требует доработки таргета)
-->
